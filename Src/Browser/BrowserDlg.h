...
namespace Browser
{
	...
	private:
		...
		void OnDragLinkDrop(CefRefPtr<CefBrowser> browser, CefString linkUrl) OVERRIDE;
	...
	private:
		...
		DuiLib::COptionUI* btnActiveNewWin;
	...
	private:
		...
		void ShowLoginDlg();
		void Login(CStdString strUserName, CStdString strPassword);
		void Logout();
	};
}
#endif